...
This leads on to the removal of low variance variables which do not make good predictors with the 
caret function nearZeroVar:
...
- The next step is to remove the highly correlated variables using the cor and findCorrelation 
functions:
...
Following on from this is the partitioning of the data into training and testing collections for cross validation purposes:
...
As they show low variance a random forest approach seems a good choice. How well it performs can be seen below:
